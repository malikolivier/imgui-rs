...
impl AppContext {
        ...
        events_loop.poll_events(|event| {
            ...
            if let Event::WindowEvent { event, .. } = event {
                match event {
                    ...
                    CursorMoved { position, .. } => mouse_state.pos = position.into(),
    ...
    pub fn imgui_mut(&mut self) -> &mut ImGui {
        &mut self.imgui
    }
}
